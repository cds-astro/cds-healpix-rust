...
impl Layer {
  ...
  pub fn zone_coverage(&self, lon_min: f64, lat_min: f64, lon_max: f64, lat_max: f64) -> BMOC {
    ...
    let mut bmoc_builder = BMOCBuilderUnsafe::new(
      self.depth,
      6 * (2 + (zone_perimeter / aprox_cell_side_at_depth_max) as usize),
    );
...
mod tests {
  ...
  fn testok_zone_1() {
    ...
    let expected_res_exact: [u64; 53] = [
      4351, 4515, 4516, 4517, 4518, 4519, 4520, 4521, 4522, 4523, 4524, 4525, 4526, 4527, 4528,
      4530, 4531, 4536, 4537, 4538, 4539, 4540, 4542, 4543, 4693, 4864, 4865, 4866, 4867, 4868,
      4869, 4870, 4871, 4873, 4876, 4877, 4878, 4879, 4880, 4881, 4882, 4883, 4884, 4885, 4886,
      4887, 4888, 4889, 4890, 4891, 4892, 4901, 4912,
    ];
