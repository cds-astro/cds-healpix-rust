...
static LUPT_TO_IJ_BYTE: [u16; 256] = [
  0x000, 0x001, 0x100, 0x101, 0x002, 0x003, 0x102, 0x103, 0x200, 0x201, 0x300, 0x301, 0x202, 0x203,
  0x302, 0x303, 0x004, 0x005, 0x104, 0x105, 0x006, 0x007, 0x106, 0x107, 0x204, 0x205, 0x304, 0x305,
  0x206, 0x207, 0x306, 0x307, 0x400, 0x401, 0x500, 0x501, 0x402, 0x403, 0x502, 0x503, 0x600, 0x601,
  0x700, 0x701, 0x602, 0x603, 0x702, 0x703, 0x404, 0x405, 0x504, 0x505, 0x406, 0x407, 0x506, 0x507,
  0x604, 0x605, 0x704, 0x705, 0x606, 0x607, 0x706, 0x707, 0x008, 0x009, 0x108, 0x109, 0x00A, 0x00B,
  0x10A, 0x10B, 0x208, 0x209, 0x308, 0x309, 0x20A, 0x20B, 0x30A, 0x30B, 0x00C, 0x00D, 0x10C, 0x10D,
  0x00E, 0x00F, 0x10E, 0x10F, 0x20C, 0x20D, 0x30C, 0x30D, 0x20E, 0x20F, 0x30E, 0x30F, 0x408, 0x409,
  0x508, 0x509, 0x40A, 0x40B, 0x50A, 0x50B, 0x608, 0x609, 0x708, 0x709, 0x60A, 0x60B, 0x70A, 0x70B,
  0x40C, 0x40D, 0x50C, 0x50D, 0x40E, 0x40F, 0x50E, 0x50F, 0x60C, 0x60D, 0x70C, 0x70D, 0x60E, 0x60F,
  0x70E, 0x70F, 0x800, 0x801, 0x900, 0x901, 0x802, 0x803, 0x902, 0x903, 0xA00, 0xA01, 0xB00, 0xB01,
  0xA02, 0xA03, 0xB02, 0xB03, 0x804, 0x805, 0x904, 0x905, 0x806, 0x807, 0x906, 0x907, 0xA04, 0xA05,
  0xB04, 0xB05, 0xA06, 0xA07, 0xB06, 0xB07, 0xC00, 0xC01, 0xD00, 0xD01, 0xC02, 0xC03, 0xD02, 0xD03,
  0xE00, 0xE01, 0xF00, 0xF01, 0xE02, 0xE03, 0xF02, 0xF03, 0xC04, 0xC05, 0xD04, 0xD05, 0xC06, 0xC07,
  0xD06, 0xD07, 0xE04, 0xE05, 0xF04, 0xF05, 0xE06, 0xE07, 0xF06, 0xF07, 0x808, 0x809, 0x908, 0x909,
  0x80A, 0x80B, 0x90A, 0x90B, 0xA08, 0xA09, 0xB08, 0xB09, 0xA0A, 0xA0B, 0xB0A, 0xB0B, 0x80C, 0x80D,
  0x90C, 0x90D, 0x80E, 0x80F, 0x90E, 0x90F, 0xA0C, 0xA0D, 0xB0C, 0xB0D, 0xA0E, 0xA0F, 0xB0E, 0xB0F,
  0xC08, 0xC09, 0xD08, 0xD09, 0xC0A, 0xC0B, 0xD0A, 0xD0B, 0xE08, 0xE09, 0xF08, 0xF09, 0xE0A, 0xE0B,
  0xF0A, 0xF0B, 0xC0C, 0xC0D, 0xD0C, 0xD0D, 0xC0E, 0xC0F, 0xD0E, 0xD0F, 0xE0C, 0xE0D, 0xF0C, 0xF0D,
  0xE0E, 0xE0F, 0xF0E, 0xF0F,
];
...
impl ZOrderCurve for EmptyZOC {
  fn ij2h(&self, _i: u32, _j: u32) -> u64 {
    0
  }
  fn i02h(&self, _i: u32) -> u64 {
    0
  }
  fn h2ij(&self, _h: u64) -> u64 {
    0
  }
  fn h2i0(&self, _h: u64) -> u64 {
    0
  }
  fn ij2i(&self, _ij: u64) -> u32 {
    0
  }
  fn ij2j(&self, _ij: u64) -> u32 {
    0
  }
}
...
impl ZOrderCurve for SmallZOC {
  ...
  fn h2ij(&self, h: u64) -> u64 {
    ...
    (LUPT_TO_IJ_BYTE[bytes[0] as usize] | LUPT_TO_IJ_BYTE[bytes[1] as usize] << 4) as u64
  }
  fn ij2i(&self, ij: u64) -> u32 {
...
impl ZOrderCurve for MediuZOC {
  fn i02h(&self, i: u32) -> u64 {
    ...
    LUPT_TO_HASH[bytes[0] as usize] as u64 | (LUPT_TO_HASH[bytes[1] as usize] as u64) << 16
  }
  fn h2ij(&self, h: u64) -> u64 {
    ...
    (LUPT_TO_IJ_SHORT[bytes[0] as usize]
      ...
      | LUPT_TO_IJ_SHORT[bytes[3] as usize] << 12) as u64
  }
  fn ij2i(&self, ij: u64) -> u32 {
...
impl ZOrderCurve for MediuZOCxor {
  fn ij2h(&self, mut i: u32, mut j: u32) -> u64 {
    i |= j << 16;
    j = (i ^ (i >> 8)) & 0x0000FF00u32;
    i = i ^ j ^ (j << 8);
    j = (i ^ (i >> 4)) & 0x00F000F0u32;
    i = i ^ j ^ (j << 4);
    j = (i ^ (i >> 2)) & 0x0C0C0C0Cu32;
    i = i ^ j ^ (j << 2);
    j = (i ^ (i >> 1)) & 0x22222222u32;
    i = i ^ j ^ (j << 1);
    i as u64
  }
  ...
  fn h2ij(&self, h: u64) -> u64 {
    let mut h = h as u32;
    let mut t = (h ^ (h >> 1)) & 0x22222222u32;
    h = h ^ t ^ (t << 1);
    t = (h ^ (h >> 2)) & 0x0C0C0C0Cu32;
    h = h ^ t ^ (t << 2);
    t = (h ^ (h >> 4)) & 0x00F000F0u32;
    h = h ^ t ^ (t << 4);
    t = (h ^ (h >> 8)) & 0x0000FF00u32;
    h = h ^ t ^ (t << 8);
    h as u64
  }
...
impl ZOrderCurve for LargeZOCxor {
  fn ij2h(&self, i: u32, j: u32) -> u64 {
    ...
    let mut t = (h ^ (h >> 16)) & 0x00000000FFFF0000u64;
    h = h ^ t ^ (t << 16);
    t = (h ^ (h >> 8)) & 0x0000FF000000FF00u64;
    h = h ^ t ^ (t << 8);
    t = (h ^ (h >> 4)) & 0x00F000F000F000F0u64;
    h = h ^ t ^ (t << 4);
    t = (h ^ (h >> 2)) & 0x0C0C0C0C0C0C0C0Cu64;
    h = h ^ t ^ (t << 2);
    t = (h ^ (h >> 1)) & 0x2222222222222222u64;
    h = h ^ t ^ (t << 1);
    h
  }
  fn i02h(&self, i: u32) -> u64 {
  ...
  fn h2ij(&self, mut h: u64) -> u64 {
    let mut t = (h ^ (h >> 1)) & 0x2222222222222222u64;
    h = h ^ t ^ (t << 1);
    t = (h ^ (h >> 2)) & 0x0C0C0C0C0C0C0C0Cu64;
    h = h ^ t ^ (t << 2);
    t = (h ^ (h >> 4)) & 0x00F000F000F000F0u64;
    ...
    t = (h ^ (h >> 8)) & 0x0000FF000000FF00u64;
    h = h ^ t ^ (t << 8);
    t = (h ^ (h >> 16)) & 0x00000000FFFF0000u64;
    h = h ^ t ^ (t << 16);
    h
  }
  fn h2i0(&self, mut h: u64) -> u64 {
...
impl ZOrderCurve for SmallZOCbmi {
  fn ij2h(&self, i: u32, j: u32) -> u64 {
    ...
    unsafe { (_pdep_u32(i, 0x00005555u32) | _pdep_u32(j, 0x0000AAAAu32)) as u64 }
  }
  fn i02h(&self, i: u32) -> u64 {
    #[cfg(target_arch = "x86")]
    use std::arch::x86::_pdep_u32;
    #[cfg(target_arch = "x86_64")]
    use std::arch::x86_64::_pdep_u32;
    unsafe { _pdep_u32(i, 0x00005555u32) as u64 }
  }
  fn oj2h(&self, j: u32) -> u64 {
    #[cfg(target_arch = "x86")]
    use std::arch::x86::_pdep_u32;
    #[cfg(target_arch = "x86_64")]
    use std::arch::x86_64::_pdep_u32;
    unsafe { _pdep_u32(j, 0x0000AAAAu32) as u64 }
  }
  fn h2ij(&self, h: u64) -> u64 {
    #[cfg(target_arch = "x86")]
  ...
  fn h2i0(&self, h: u64) -> u64 {
    ...
    #[cfg(target_arch = "x86_64")]
    use std::arch::x86_64::_pext_u32;
    unsafe { _pext_u32(h as u32, 0x00005555u32) as u64 }
  }
  fn ij2i(&self, ij: u64) -> u32 {
    (ij as u32) & 0x000000FFu32
  }
  fn ij2j(&self, ij: u64) -> u32 {
    (ij as u32) >> 8
  }
...
impl ZOrderCurve for MediuZOCbmi {
  fn ij2h(&self, i: u32, j: u32) -> u64 {
    ...
    #[cfg(target_arch = "x86_64")]
    use std::arch::x86_64::_pdep_u32;
    unsafe { (_pdep_u32(i, 0x55555555u32) | _pdep_u32(j, 0xAAAAAAAAu32)) as u64 }
  }
  fn i02h(&self, i: u32) -> u64 {
    #[cfg(target_arch = "x86")]
    use std::arch::x86::_pdep_u32;
    #[cfg(target_arch = "x86_64")]
    use std::arch::x86_64::_pdep_u32;
    unsafe { _pdep_u32(i, 0x55555555u32) as u64 }
  }
  fn oj2h(&self, i: u32) -> u64 {
    ...
    #[cfg(target_arch = "x86_64")]
    use std::arch::x86_64::_pdep_u32;
    unsafe { _pdep_u32(i, 0xAAAAAAAAu32) as u64 }
  }
  fn h2ij(&self, h: u64) -> u64 {
    #[cfg(target_arch = "x86")]
    use std::arch::x86::_pext_u32;
  ...
  fn h2i0(&self, h: u64) -> u64 {
    ...
    #[cfg(target_arch = "x86_64")]
    use std::arch::x86_64::_pext_u32;
    unsafe { _pext_u32(h as u32, 0x55555555u32) as u64 }
  }
  fn ij2i(&self, ij: u64) -> u32 {
    (ij as u32) & 0x0000FFFFu32
  }
  fn ij2j(&self, ij: u64) -> u32 {
    (ij as u32) >> 16
  }
...
pub fn get_zoc(depth: u8) -> &'static dyn ZOrderCurve {
  // on day, It would be possible to add 'const'
