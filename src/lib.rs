...
static SMALLER_EDGE2OPEDGE_DIST: [f64; 30] = [
  ...
  3.772363172221682e-1,  // depth = 1
  1.820336496604032e-1,  // depth = 2
  8.911454164164473e-2,  // depth = 3
  4.3989734587906136e-2, // depth = 4
  2.1817362566999756e-2, // depth = 5
  1.0854009738967782e-2, // depth = 6
  5.409888146009395e-3,  // depth = 7
  2.699583333229803e-3,  // depth = 8
  1.3481074890890777e-3, // depth = 9
  6.735240936621056e-4,  // depth = 10
  3.365953703468212e-4,  // depth = 11
  1.6824522036126843e-4, // depth = 12
  8.410609068655501e-5,  // depth = 13
  4.204784323221455e-5,  // depth = 14
  2.1022283308073835e-5, // depth = 15
